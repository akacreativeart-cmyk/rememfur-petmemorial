...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Honor, remember, and celebrate your pet with a beautiful AI-illustrated memorial, a paw lamp wall, and a community that understands." },
      ...
      { property: "og:description", content: "Honor, remember, and celebrate your pet with a beautiful AI-illustrated memorial, a paw lamp wall, and a community that understands." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Rememfur — A gentle pet memorial for the love that stays" },
      { name: "twitter:description", content: "Honor, remember, and celebrate your pet with a beautiful AI-illustrated memorial, a paw lamp wall, and a community that understands." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Lora:ital,wght@0,400;0,500;0,600;1,400;1,500&family=Nunito+Sans:wght@300;400;500;600;700&family=Caveat:wght@400;600;700&display=swap",
      },
    ],
    scripts: [
      {
